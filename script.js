...
var resumeString = "<div>Sorry Comming Soon </div>";
...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "resume":
            ...
            break;
        case "skills":
            sendTextMessage("<span class='sk'>Saya Bisa <br><br>:<br><span class='bold'>Java<br>C++<br>C<br>PHP<br>Kotlin<br>Dart<br>Python<br>CSS<br>HTML</span><br><br>I've experiance with following frameworks :<span class='bold'><br>Android<br>Flutter<br>ReactJs<br>GTK</span><br><br>I use <span class='bold'>Windows</span><br>OS:Windows 11D<br>Favourite IDE:VSCode</span>");
            break;
